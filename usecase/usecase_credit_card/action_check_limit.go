...
func (usecase *CreditCardUsecaseImpl) CheckLimitAction(idRequest string, kosong interface{}, bodyRequest dto.ReqDownstreamCheckLimit) (httpCode int, res dto.Res) {
	...
	if err != nil {
		...
		httpCode, res, logUpstream.IsSuccess = usecase.MappingOutputCheckLimit(kosong, bodyRequest, resStruct)
	}
