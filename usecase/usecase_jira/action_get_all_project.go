...
func (usecase *JiraUsecaseImpl) GetAllProjectAction(kosong interface{}, idRequest string) (httpCode int, res dto.Res, data []dto.ResUpstreamGetAllProject) {
	...
	if err != nil {
		...
		json.Unmarshal(resUpstream.Body(), &data)
