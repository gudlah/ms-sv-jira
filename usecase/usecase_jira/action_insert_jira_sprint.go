...
func (usecase *JiraUsecaseImpl) InsertJiraSprintAction(kosong interface{}, sprints []dto.ResDownstreamGetAllSprint, httpCodeAsal int, resAsal dto.Res) (httpCode int, res dto.Res) {
