...
func (usecase *JiraUsecaseImpl) GetAllColumnAction(kosong interface{}, idRequest string, boardId int) (httpCode int, res dto.Res, resStruct dto.ResUpstreamGetAllColumn) {
