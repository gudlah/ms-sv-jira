...
func (usecase *JiraUsecaseImpl) GetAllCardAction(kosong interface{}, idRequest string, sprintId int) (httpCode int, res dto.Res, resStruct dto.ResUpstreamGetAllCard) {
