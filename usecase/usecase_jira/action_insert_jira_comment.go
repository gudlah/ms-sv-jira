...
func (usecase *JiraUsecaseImpl) InsertJiraCommentAction(kosong interface{}, comments []dto.CommentDownstreamGetAllCard, httpCodeAsal int, resAsal dto.Res) (httpCode int, res dto.Res) {
