...
func (usecase *JiraFullUsecaseImpl) InsertJiraSubTaskAction(kosong interface{}, subTasks []dto.SubTaskDownstreamGetAllFull, httpCodeAsal int, resAsal dto.Res) (httpCode int, res dto.Res) {
