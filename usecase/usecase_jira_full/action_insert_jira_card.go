...
func (usecase *JiraFullUsecaseImpl) InsertJiraCardAction(kosong interface{}, cards []dto.CardDownstreamGetAllFull, httpCodeAsal int, resAsal dto.Res) (httpCode int, res dto.Res) {
