...
func (usecase *JiraFullUsecaseImpl) InsertJiraAttachmentAction(kosong interface{}, attachments []dto.AttachmentDownstreamGetAllFull, httpCodeAsal int, resAsal dto.Res) (httpCode int, res dto.Res) {
