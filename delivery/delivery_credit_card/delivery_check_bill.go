...
// Check Bill godoc
// @Summary Check Bill
// @Description Check bill of credit card
// @Tags Credit Card
// @Accept json
// @Produce json
// @param Authorization header string true "Authorization" default(Bearer <Add access token here>)
// @Param Request body dto.ReqDownstreamCheckBill true "Body Request"
// @Success 200 {object} dto.SwaggerCheckBillSuccess
...
func (delivery *CreditCardDeliveryImpl) CheckBillDelivery(ginContext *gin.Context) {
	...
	if err != nil {
		...
		if err != nil {
			...
			httpCode, res = delivery.CreditCardUsecase.CheckBillUsecase(idRequest, kosong, reqStruct)
		}
	}
